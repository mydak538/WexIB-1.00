...
$(BIOSMENU_O): $(BIOSMENU_SRC) include/stdint.h include/post.h include/efficiency.h include/cpu.h include/rtc.h
	@mkdir -p $(BIN_DIR)
...
$(CONSOLE_O): $(CONSOLE_SRC) include/post.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) -c $(CONSOLE_SRC) -o $(CONSOLE_O)

$(EFFICIENCY_O): $(EFFICIENCY_SRC) include/efficiency.h
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) -c $(EFFICIENCY_SRC) -o $(EFFICIENCY_O)

# Правило для cpu.c
$(CPU_O): $(CPU_SRC) include/cpu.h 
	@mkdir -p $(BIN_DIR)
	$(CC) $(CFLAGS) -c $(CPU_SRC) -o $(CPU_O)

# ДОБАВЛЕНО: Правило для rtc.c
$(rtc_O): $(rtc_SRC) include/rtc.h include/cpu.h
	@mkdir -p $(BIN_DIR)
